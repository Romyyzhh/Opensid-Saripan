...
export default function UserLogin() {
    ...
    return (
        <>
            <Head title="Login Pengguna - OpenSID Desa Saripan" />
            <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center p-4 text-gray-900">
                ...
                <div className="relative w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">
                            Masuk ke akun OpenSID Desa Saripan
                        </p>
                    </div>
